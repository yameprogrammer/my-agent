...
pkg update -y
pkg install python nodejs postgresql git clang make build-essential libjpeg-turbo libpng pango cairo gdk-pixbuf libffi libxml2 libxslt python-cryptography python-numpy python-pandas python-pyarrow python-grpcio -y
